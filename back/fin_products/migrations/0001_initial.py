# Generated by Django 4.2.6 on 2024-05-17 04:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saving', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fin_products.saving')),
            ],
        ),
        migrations.CreateModel(
            name='LoanOption',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mrtg_type', models.CharField(blank=True, max_length=20)),
                ...
                ('loan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fin_products.loan')),
            ],
        ),
        migrations.CreateModel(
            name='DepositOption',
            fields=[
                ...
                ('intr_rate', models.FloatField(null=True)),
                ('intr_rate2', models.FloatField(null=True)),
                ('deposit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fin_products.deposit')),
            ],
        ),
    ]
